...
export class CategoriesApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createCategory(createNewCategoryRequest: CreateNewCategoryRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'createNewCategoryRequest' is not null or undefined
        if (createNewCategoryRequest === null || createNewCategoryRequest === undefined) {
            throw new RequiredError("CategoriesApi", "createCategory", "createNewCategoryRequest");
        }
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(createNewCategoryRequest, "CreateNewCategoryRequest", ""),
            contentType
        );
     ...
     */
    public async deleteCategory(id: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError("CategoriesApi", "deleteCategory", "id");
        }
     ...
     * @param id Category ID
     */
    public async getCategoryById(id: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError("CategoriesApi", "getCategoryById", "id");
        }
     ...
     */
    public async reorderCategories(reorderCategoriesRequest: ReorderCategoriesRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'reorderCategoriesRequest' is not null or undefined
        if (reorderCategoriesRequest === null || reorderCategoriesRequest === undefined) {
            throw new RequiredError("CategoriesApi", "reorderCategories", "reorderCategoriesRequest");
        }
        ...
        requestContext.setHeaderParam("Content-Type", contentType);
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(reorderCategoriesRequest, "ReorderCategoriesRequest", ""),
            contentType
        );
        requestContext.setBody(serializedBody);
     ...
     */
    public async updateCategory(id: number, updateCategory: UpdateCategory, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError("CategoriesApi", "updateCategory", "id");
        }


        // verify required parameter 'updateCategory' is not null or undefined
        if (updateCategory === null || updateCategory === undefined) {
            throw new RequiredError("CategoriesApi", "updateCategory", "updateCategory");
        }
...
export class CategoriesApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteCategoryWithHttpInfo(response: ResponseContext): Promise<HttpInfo<any >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        ...
        if (isCodeInRange("404", response.httpStatusCode)) {
            throw new ApiException<undefined>(response.httpStatusCode, "Category not found", undefined, response.headers);
        }
        if (isCodeInRange("409", response.httpStatusCode)) {
            throw new ApiException<undefined>(response.httpStatusCode, "Cannot delete category with services", undefined, response.headers);
        }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getCategoryByIdWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Category >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: Category = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to reorderCategories
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async reorderCategoriesWithHttpInfo(response: ResponseContext): Promise<HttpInfo<any >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: any = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
